...
public class S1_03_TankDriveSolutionTeleOp extends OpMode {
    ...
    @Override
    public void loop() {
        double left = LESSON_SPEED * HardwareMapUtil.forwardInput(gamepad1.left_stick_y);
        double right = LESSON_SPEED * HardwareMapUtil.forwardInput(gamepad1.right_stick_y);
